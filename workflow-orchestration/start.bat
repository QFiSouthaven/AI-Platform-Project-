@echo off
REM Windows startup script for Workflow Orchestration module
REM This script starts the FastAPI application on Windows 11

setlocal enabledelayedexpansion

echo ============================================
echo  Workflow Orchestration - Windows Startup
echo ============================================
echo.
...
echo Starting Workflow Orchestration on %HOST%:%PORT%...
echo.
